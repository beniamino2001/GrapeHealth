...
// Catalogo bibliografico delle azioni di mitigazione: sei azioni, sette associazioni
// regola->azione, di sola consultazione, popolate dal seed e mai modificate a runtime.
// Caricata una sola volta all'avvio invece di essere interrogata a ogni richiesta.
// ConcurrentHashMap invece di HashMap perche' le mappe sono lette concorrentemente da
// piu' richieste HTTP mentre vengono popolate in carica(); nessuna scrittura avviene
// dopo l'avvio.
@Component
